...
namespace Collaboration_LLS.Panel
{
    public partial class ResetPassword : System.Web.UI.Page
    {
        ...
        protected void btnReset_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.AddWithValue("@password", code.Value);
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                {
                    cmd = new SqlCommand("UPDATE [User] SET [Password] = @newPassword where [User].[Password]=@oldPassword", con);
                    cmd.Parameters.AddWithValue("@newpassword", newPassword.Value);
                    cmd.Parameters.AddWithValue("@oldpassword", code.Value);
                    cmd.ExecuteNonQuery();
