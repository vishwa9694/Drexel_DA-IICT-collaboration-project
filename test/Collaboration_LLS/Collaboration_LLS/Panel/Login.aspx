<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Collaboration_LLS.Panel.Login" %>
...
<head>
        ...
        <title>Leukemia & Lymphoma Society</title>
                ...
                <section class="panel panel-default">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">
                            ...
                            <div class="form-group">
                                <label id="Label2" for="password" runat="server">Password</label>
                                <input type="password" runat="server" name="txtPassword" class="form-control input-lg" id="password" placeholder="Password" />
                            </div>
                        </li>
                    </ul>
                    <div class="panel-footer">
                        <asp:Button ID="btnLogin" runat="server" class="btn btn-lg btn-success" Text="LOGIN TO YOUR ACCOUNT" OnClick="btnLogin_Click" />
                        <br>
